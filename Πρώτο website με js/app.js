...
//make sections
createSection("home","Features","Η JavaScript προσφέρει πολλά χαρακτηριστικά όπως διαδραστικότητα, δυναμική ενημέρωση περιεχομένου, και υποστήριξη για διάφορες βιβλιοθήκες και πλαίσια εργασίας" , "images/Features.jpg");
